...
class RolePlaying:
    ...
    def __init__(
        ...
        chatdev_prompt_template = "ChatDev is a company powered by multiple intelligent agents, such as chief executive officer, chief human resources officer, chief product officer, chief technology officer, etc, with a multi-agent organizational structure and the mission of \"Inspiring Delight\"."
